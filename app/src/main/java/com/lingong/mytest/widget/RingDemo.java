 ...
 * 可适用于上传下载
 */
public class RingDemo extends View {
    ...
    public RingDemo(Context context) {

        this(context, null);
    }


    public RingDemo(Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }


    public RingDemo(Context context, AttributeSet attrs, int defStyle) {
        ...
        ringProgressColor = mTypedArray.getColor(R.styleable.RingProgressBar_ringProgressColor,
                Color.BLUE);
        textColor = mTypedArray.getColor(R.styleable.RingProgressBar_textPrgColor, Color.BLACK);
        textSize = mTypedArray.getDimension(R.styleable.RingProgressBar_textPrgSize, 16);

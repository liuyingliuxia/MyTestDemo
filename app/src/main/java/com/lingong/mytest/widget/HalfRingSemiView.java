 ...
 */
public class HalfRingSemiView extends View {

    private static final String TAG = com.yhd.semicircle.SemiCircleView.class.getSimpleName();
    ...
    public HalfRingSemiView(Context context) {
        this(context, null);
    }

    public HalfRingSemiView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HalfRingSemiView(Context context, AttributeSet attrs, int defStyleAttr) {

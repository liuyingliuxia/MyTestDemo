...
public class _ShellUtils {
    ...
    public static CommandResult execCommand(String[] commands, boolean isRoot,
        ...
        CommandResult result1 = new CommandResult(result, successMsg == null ? null
                : successMsg.toString(), errorMsg == null ? null
                : errorMsg.toString());

        Log.d("ShellUtils", String.format("command:%s,result:%s,errorMsg:%s,successMsg:%s", commands[0]
                , result, errorMsg, successMsg));
        return result1;
    }

 ...
 * Descripe:  dialog 背景高斯模糊
 */
public class FastBlurUtil {

    private static FastBlurUtil instance;

    private FastBlurUtil() {
    }

    public static FastBlurUtil getInstance() {
        if (instance == null) {
            instance = new FastBlurUtil();
        }
        return instance;
    }
     ...
     * @return 模糊化的背景图片
     */
    public Bitmap getBlurBackgroundDrawer(Activity activity) {
        Bitmap bmp = takeScreenShot(activity, null);
     ...
     * @return 模糊化的背景图片
     */
    public Bitmap getBlurBackgroundDrawer(Activity activity, View view) {
        Bitmap bmp = takeScreenShot(activity, view);
        return startBlurBackground(bmp);
    }
     ...
     * @return 截屏图片
     */
    private Bitmap takeScreenShot(Activity activity, View v) {
        View view;
        if (v != null) {
            view = v;
...
//        else
    ...
    private Bitmap startBlurBackground(Bitmap bkg) {
